# Llama 3.2 1B BeeS training notebooks

These notebooks train one non-TIDPO preference method per Kaggle **GPU T4 x2** session
from `meta-llama/Llama-3.2-1B-Instruct` at pinned revision `9213176726f574b556790deb65791e0c5aa438b6`. TIDPO is deliberately
...
| # | Method | Notebook |
|---:|---|---|
| 1 | VPDPO B_norm-DPO | `01_llama32_1b_b_norm_dpo_kaggle_t4x2.ipynb` |
| 2 | VPDPO B_norm-VDPO | `02_llama32_1b_b_norm_vdpo_kaggle_t4x2.ipynb` |
| 3 | VPDPO B-DPO | `03_llama32_1b_b_dpo_kaggle_t4x2.ipynb` |
| 4 | VPDPO B-VDPO | `04_llama32_1b_b_vdpo_kaggle_t4x2.ipynb` |
| 5 | VPDPO C-DPO | `05_llama32_1b_c_dpo_kaggle_t4x2.ipynb` |
| 6 | VPDPO C-VDPO | `06_llama32_1b_c_vdpo_kaggle_t4x2.ipynb` |
| 7 | Simple DPO | `07_llama32_1b_simple_dpo_kaggle_t4x2.ipynb` |
| 8 | VPDPO A | `08_llama32_1b_vpdpo_a_kaggle_t4x2.ipynb` |
| 9 | SimPO | `09_llama32_1b_simpo_kaggle_t4x2.ipynb` |
| 10 | SamPO | `10_llama32_1b_sampo_kaggle_t4x2.ipynb` |
